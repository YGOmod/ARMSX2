...
public class SettingsActivity extends AppCompatActivity {
    ...
    private SharedPreferences prefsName;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        prefsName = getSharedPreferences("armsx2", MODE_PRIVATE);
    ...
    private void initializeGeneralSettings() {
        ...
        if (disableTouchControls) {
            ...
            int cur = 3;
            try {
                cur = prefsName.getInt("onscreen_timeout_seconds", 3);
            } catch (Throwable ignored) { }
            if (cur < 0) cur = 0;
            if (cur > 60) cur = 60;
    ...
    private void initializeGraphicsSettings() {
        ...
        spRenderer.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mIgnoreRendererInit || ignoreInit[0]) {
                    mIgnoreRendererInit = false;
                    ignoreInit[0] = false;
                    return;
                }
        ...
        if (sbUpscale != null && tvUpscale != null) {
            ...
            sbUpscale.addOnChangeListener((slider, value, fromUser) -> {
                ...
                if (mult != Math.round(value)) {
                    slider.setValue(mult);
                }
                tvUpscale.setText("Upscale: " + mult + "x");
        ...
        if (spTexturePreload != null) {
            ...
            try {
                ...
                if (val < 0 || val >= preloadAdapter.getCount()) {
                    val = 0;
                }
        ...
        if (spAccBlending != null) {
            ...
            try {
                ...
                if (val < 0 || val >= blendAdapter.getCount()) {
                    val = 1;
                }
        ...
        if (spTrilinear != null) {
            ...
            try {
                ...
                if (val < 0 || val >= triAdapter.getCount()) {
                    val = 0;
                }
        ...
        if (spDithering != null) {
            ...
            try {
                ...
                if (val < 0 || val >= ditheringAdapter.getCount()) {
                    val = 2;
                }
        ...
        if (spBilinearPresent != null) {
            ...
            try {
                ...
                if (val < 0 || val >= bilinearAdapter.getCount()) {
                    val = 2;
                }
    ...
    private void updateOnScreenUiStyleSummary() {
        ...
        String current = prefsName.getString("on_screen_ui_style", "default");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQ_IMPORT_MEMCARD && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                java.util.Set<String> existingDirs = prefsName.getStringSet("secondary_game_dirs", new java.util.HashSet<>());
                java.util.Set<String> newDirs = new java.util.HashSet<>(existingDirs);
                newDirs.add(uriString);
                prefsName.edit().putStringSet("secondary_game_dirs", newDirs).apply();
